...
/*
Funcion: verificar_subcuadros.
Objetivo: verificar que no se repiten valores en cada uno de los subcuadros.
Retorna: retorna 1 si es valido y 0 si no lo es.
*/
...
Objetivo: verificar que no se repiten valores en las columnas.
Retorna: retorna 1 si es valido y 0 si no lo es.
*/
...
Objetivo: verificar que no se repiten valores en las filas.
Retorna: retorna 1 si es valido y 0 si no lo es.
*/
...
/*
Funcion: mostrar_arr.
Objetivo: mostrar la matriz en pantalla con los valores digitados por el usuario.
Retorna: No retorna, es void.
*/
...
/*
Funcion: llenar_arr.
Objetivo: Llenar la matriz con los valores digitados por el usuario.
Retorna: No retorna, es void.
*/
    ...
    for(int i=0; i<tam; i++)
    {
        for(int j=0; j<tam; j++)
        {
            do
            {
                ...
                scanf("%d", (arr + i*tam + j) );
                if(*(arr + i*tam + j) < 1 || *(arr + i*tam + j) > tam)
				{
					printf("\nValor fuera de rango\n");
					system("PAUSE");
					system("CLS");
				}
            }while(*(arr + i*tam + j) < 1 || *(arr + i*tam + j) > tam);
